...
// Model params
const MAX_TIMEOUTS = 4;
const TIMEOUT_MULT_FACTOR = 3;
...
formula reconf_done = (MS_selected>0) & (DS_selected>0) & (AS_selected>0);

module reconf
	MS_selected: [0..5] init 0;
	DS_selected: [0..5] init 0;
	AS_selected: [0..5] init 0;
	
	[select_MS1] (MS_selected=0) -> (MS_selected'=1);
	[select_MS2] (MS_selected=0) -> (MS_selected'=2);
	[select_MS3] (MS_selected=0) -> (MS_selected'=3);
	[select_MS4] (MS_selected=0) -> (MS_selected'=4);
	[select_MS5] (MS_selected=0) -> (MS_selected'=5);

	[select_DS1] (MS_selected>0) & (DS_selected=0) -> (DS_selected'=1);

	[select_AS1] (MS_selected>0) & (DS_selected>0) & (AS_selected=0) -> (AS_selected'=1);
	[select_AS2] (MS_selected>0) & (DS_selected>0) & (AS_selected=0) -> (AS_selected'=2);
	[select_AS3] (MS_selected>0) & (DS_selected>0) & (AS_selected=0) -> (AS_selected'=3);
...
module MS1  
  ...
  [MS1_analyzeDataCall] (MS_selected=1) & (MS1_ready) -> MS1_failure_rate: (MS1_serviceOK'=false) & (MS1_ready'=false) + 1-MS1_failure_rate: (MS1_serviceOK'=true) & (MS1_ready'=false);
  [MS1_analysisResultPatientOK]  (MS_selected=1) & (!MS1_ready) & (MS1_serviceOK)  -> (MS1_serviceOK'=false) & (MS1_ready'=true);
  [MS1_analysisResultChangeDrug] (MS_selected=1) & (!MS1_ready) & (MS1_serviceOK)  -> (MS1_serviceOK'=false) & (MS1_ready'=true);
  [MS1_analysisResultChangeDose] (MS_selected=1) & (!MS1_ready) & (MS1_serviceOK)  -> (MS1_serviceOK'=false) & (MS1_ready'=true);
  [MS1_analysisResultSendAlarm]  (MS_selected=1) & (!MS1_ready) & (MS1_serviceOK)  -> (MS1_serviceOK'=false) & (MS1_ready'=true);
  [MS1_timeout]                  (MS_selected=1) & (!MS1_ready) & (!MS1_serviceOK) -> (MS1_ready'=true);
endmodule
...
module MS2  
  ...
  [MS2_analyzeDataCall] (MS_selected=2) & (MS2_ready) -> MS2_failure_rate: (MS2_serviceOK'=false) & (MS2_ready'=false) + 1-MS2_failure_rate: (MS2_serviceOK'=true) & (MS2_ready'=false);
  [MS2_analysisResultPatientOK]  (MS_selected=2) & (!MS2_ready) & (MS2_serviceOK)  -> (MS2_serviceOK'=false) & (MS2_ready'=true);
  [MS2_analysisResultChangeDrug] (MS_selected=2) & (!MS2_ready) & (MS2_serviceOK)  -> (MS2_serviceOK'=false) & (MS2_ready'=true);
  [MS2_analysisResultChangeDose] (MS_selected=2) & (!MS2_ready) & (MS2_serviceOK)  -> (MS2_serviceOK'=false) & (MS2_ready'=true);
  [MS2_analysisResultSendAlarm]  (MS_selected=2) & (!MS2_ready) & (MS2_serviceOK)  -> (MS2_serviceOK'=false) & (MS2_ready'=true);
  [MS2_timeout]                  (MS_selected=2) & (!MS2_ready) & (!MS2_serviceOK) -> (MS2_ready'=true);
endmodule
...
module MS3  
  ...
  [MS3_analyzeDataCall] (MS_selected=3) & (MS3_ready) -> MS3_failure_rate: (MS3_serviceOK'=false) & (MS3_ready'=false) + 1-MS3_failure_rate: (MS3_serviceOK'=true) & (MS3_ready'=false);
  [MS3_analysisResultPatientOK]  (MS_selected=3) & (!MS3_ready) & (MS3_serviceOK)  -> (MS3_serviceOK'=false) & (MS3_ready'=true);
  [MS3_analysisResultChangeDrug] (MS_selected=3) & (!MS3_ready) & (MS3_serviceOK)  -> (MS3_serviceOK'=false) & (MS3_ready'=true);
  [MS3_analysisResultChangeDose] (MS_selected=3) & (!MS3_ready) & (MS3_serviceOK)  -> (MS3_serviceOK'=false) & (MS3_ready'=true);
  [MS3_analysisResultSendAlarm]  (MS_selected=3) & (!MS3_ready) & (MS3_serviceOK)  -> (MS3_serviceOK'=false) & (MS3_ready'=true);
  [MS3_timeout]                  (MS_selected=3) & (!MS3_ready) & (!MS3_serviceOK) -> (MS3_ready'=true);
endmodule
...
module MS4  
  ...
  [MS4_analyzeDataCall] (MS_selected=4) & (MS4_ready) -> MS4_failure_rate: (MS4_serviceOK'=false) & (MS4_ready'=false) + 1-MS4_failure_rate: (MS4_serviceOK'=true) & (MS4_ready'=false);
  [MS4_analysisResultPatientOK]  (MS_selected=4) & (!MS4_ready) & (MS4_serviceOK)  -> (MS4_serviceOK'=false) & (MS4_ready'=true);
  [MS4_analysisResultChangeDrug] (MS_selected=4) & (!MS4_ready) & (MS4_serviceOK)  -> (MS4_serviceOK'=false) & (MS4_ready'=true);
  [MS4_analysisResultChangeDose] (MS_selected=4) & (!MS4_ready) & (MS4_serviceOK)  -> (MS4_serviceOK'=false) & (MS4_ready'=true);
  [MS4_analysisResultSendAlarm]  (MS_selected=4) & (!MS4_ready) & (MS4_serviceOK)  -> (MS4_serviceOK'=false) & (MS4_ready'=true);
  [MS4_timeout]                  (MS_selected=4) & (!MS4_ready) & (!MS4_serviceOK) -> (MS4_ready'=true);
endmodule
...
module MS5  
  ...
  [MS5_analyzeDataCall] (MS_selected=5) & (MS5_ready) -> MS5_failure_rate: (MS5_serviceOK'=false) & (MS5_ready'=false) + 1-MS5_failure_rate: (MS5_serviceOK'=true) & (MS5_ready'=false);
  [MS5_analysisResultPatientOK]  (MS_selected=5) & (!MS5_ready) & (MS5_serviceOK)  -> (MS5_serviceOK'=false) & (MS5_ready'=true);
  [MS5_analysisResultChangeDrug] (MS_selected=5) & (!MS5_ready) & (MS5_serviceOK)  -> (MS5_serviceOK'=false) & (MS5_ready'=true);
  [MS5_analysisResultChangeDose] (MS_selected=5) & (!MS5_ready) & (MS5_serviceOK)  -> (MS5_serviceOK'=false) & (MS5_ready'=true);
  [MS5_analysisResultSendAlarm]  (MS_selected=5) & (!MS5_ready) & (MS5_serviceOK)  -> (MS5_serviceOK'=false) & (MS5_ready'=true);
  [MS5_timeout]                  (MS_selected=5) & (!MS5_ready) & (!MS5_serviceOK) -> (MS5_ready'=true);
endmodule
...
module DS1
  ...
  [DS1_changeDrugCall] (DS_selected=1) & (DS1_ready) -> DS1_failure_rate: (DS1_serviceOK'=false) & (DS1_ready'=false) + 1-DS1_failure_rate: (DS1_serviceOK'=true) & (DS1_ready'=false);
  [DS1_changeDrugOK]   (DS_selected=1) & (!DS1_ready) & (DS1_serviceOK)  -> (DS1_serviceOK'=false) & (DS1_ready'=true);

  [DS1_changeDoseCall] (DS_selected=1) & (DS1_ready) -> DS1_failure_rate: (DS1_serviceOK'=false) & (DS1_ready'=false) + 1-DS1_failure_rate: (DS1_serviceOK'=true) & (DS1_ready'=false);
  [DS1_changeDoseOK]   (DS_selected=1) & (!DS1_ready) & (DS1_serviceOK)  -> (DS1_serviceOK'=false) & (DS1_ready'=true);

  [DS1_timeout] (DS_selected=1) & (!DS1_ready) & (!DS1_serviceOK) -> (DS1_ready'=true);
endmodule
...
module AS1
  ...
  [AS1_sendAlarmCall] (AS_selected=1) & (AS1_ready) -> AS1_failure_rate: (AS1_serviceOK'=false) & (AS1_ready'=false) + 1-AS1_failure_rate: (AS1_serviceOK'=true) & (AS1_ready'=false);
  [AS1_sendAlarmOK]  (AS_selected=1) & (!AS1_ready) & (AS1_serviceOK)  -> (AS1_serviceOK'=false) & (AS1_ready'=true);
  [AS1_timeout] (AS_selected=1) & (!AS1_ready) & (!AS1_serviceOK) -> (AS1_ready'=true);
endmodule
...
module AS2
  ...
  [AS2_sendAlarmCall] (AS_selected=2) & (AS2_ready) -> AS2_failure_rate: (AS2_serviceOK'=false) & (AS2_ready'=false) + 1-AS2_failure_rate: (AS2_serviceOK'=true) & (AS2_ready'=false);
  [AS2_sendAlarmOK]  (AS_selected=2) & (!AS2_ready) & (AS2_serviceOK)  -> (AS2_serviceOK'=false) & (AS2_ready'=true);
  [AS2_timeout] (AS_selected=2) & (!AS2_ready) & (!AS2_serviceOK) -> (AS2_ready'=true);
endmodule
...
module AS3
  ...
  [AS3_sendAlarmCall] (AS_selected=3) & (AS3_ready) -> AS3_failure_rate: (AS3_serviceOK'=false) & (AS3_ready'=false) + 1-AS3_failure_rate: (AS3_serviceOK'=true) & (AS3_ready'=false);
  [AS3_sendAlarmOK]  (AS_selected=3) & (!AS3_ready) & (AS3_serviceOK)  -> (AS3_serviceOK'=false) & (AS3_ready'=true);
  [AS3_timeout] (AS_selected=3) & (!AS3_ready) & (!AS3_serviceOK) -> (AS3_ready'=true);
endmodule
