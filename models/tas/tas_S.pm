...
module reconf
	...
	[select_MS1] (MS_selected<5) & (MS1_selected=0) -> (MS1_selected'=1);
	[select_MS2] (MS_selected<5) & (MS2_selected=0) -> (MS2_selected'=1);
	[select_MS3] (MS_selected<5) & (MS3_selected=0) -> (MS3_selected'=1);
	[select_MS4] (MS_selected<5) & (MS4_selected=0) -> (MS4_selected'=1);
	[select_MS5] (MS_selected<5) & (MS5_selected=0) -> (MS5_selected'=1);

	[select_DS1] (MS_selected>0) & (DS_selected<3) & (DS1_selected=0) -> (DS1_selected'=1);

	[select_AS1] (MS_selected>0) & (DS_selected>0) & (AS_selected<3) & (AS1_selected=0) -> (AS1_selected'=1);
	[select_AS2] (MS_selected>0) & (DS_selected>0) & (AS_selected<3) & (AS2_selected=0) -> (AS2_selected'=1);
	[select_AS3] (MS_selected>0) & (DS_selected>0) & (AS_selected<3) & (AS3_selected=0) -> (AS3_selected'=1);
